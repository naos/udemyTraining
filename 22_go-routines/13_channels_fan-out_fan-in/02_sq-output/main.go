...
-- stages close their outbound channels when all the send operations are done.append
-- stages keep recieving values from inbound channels until those channels are closed.
...
/*
CHALLENGE #1
We know HOW to do fan out / fan in, but do we know WHY?
